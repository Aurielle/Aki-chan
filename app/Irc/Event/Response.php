 ...
 *  Heavily inspired by Phergie_Event_Response
 */
class Response extends Event
{
	...
	/**
	 * Welcome message from the server, text varies.
	 */
	const RPL_WELCOME = '001';

	/**
	 * Part of post-registration greeting, text varies.
	 */
	...
	/**
	 * Used for announcing network spam policy. Deprecated.
	 */
	const RPL_SPAM = '377';
	...
	/**
	 * Displays connection statistics, format unknown.
	 */
	...
	/**
	 * Events that contain current nick.
	 * @var array
	 */
	public static $nickSetters = array(
		self::RPL_WELCOME, self::RPL_YOURHOST, self::RPL_CREATED, self::RPL_MYINFO, self::RPL_BOUNCE,
		self::RPL_STATSCONN, self::RPL_LUSERCHANNELS, self::RPL_LUSERME, self::RPL_LOCALUSERS,
		self::RPL_GLOBALUSERS, self::RPL_MOTD, self::RPL_MOTDSTART, self::RPL_ENDOFMOTD,
		self::RPL_TOPICWHOTIME, self::RPL_NAMEREPLY, self::RPL_TOPIC, self::RPL_ENDOFNAMES,
	);
	 ...
	 * @return Aki\Irc\Event\Response Provides a fluent interface
	 */
